...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        address t1_addr = ownerOf(_tokenId1);
        address t2_addr = ownerOf(_tokenId2);
        require(t1_addr != t2_addr, 'same owner');
        require(t1_addr == msg.sender || t2_addr == msg.sender, 'must anyone is owner');
        //_transferFrom(ownerAddress, msg.sender, _tokenId)
        _transferFrom(t1_addr,t2_addr,_tokenId1);
        _transferFrom(t2_addr,t1_addr,_tokenId2);
    }
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId)==msg.sender,'must owner');
